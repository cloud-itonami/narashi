...
- **DID**: `did:web:etzhayyim.com:actor:narashi` (RID `rad:bafkreiesq7hilvsa2nlth7snkzrnwqkrrjgv6dx4dmnr77prxfmlacojs4`, published via `kbb --backend sci scripts/run-task.cljk actor:publish narashi --apply` in etzhayyim/root, ADR-2606231200)
